...
public class StringFirstUniqueCharInString {

    public static void main(String[] args) {
        System.out.println(getFirstNonRepeatedChar("uma"));
        System.out.println( firstNonRepeatingChar("kauthik"));
        System.out.println( firstNonRepeatedCharacter("Ashok"));


    }
    /**
     * Java Program to find first unique, non-repeated character in a String.
